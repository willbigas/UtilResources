...
public class ProdutoTableModel extends AbstractTableModel implements ActionsTableModel<Produto>{
     ...
     * @return
     */
    public Produto getObject(int indiceLinha) {
     ...
     * @param produto
     */
    public void addObject(Produto produto) {
        linhas.add(produto);
     ...
     * @param p
     */
    public void updateObject(int indiceLinha, Produto p) {
     ...
     * @param produtos
     */
    public void addListOfObject(List<Produto> produtos) {
