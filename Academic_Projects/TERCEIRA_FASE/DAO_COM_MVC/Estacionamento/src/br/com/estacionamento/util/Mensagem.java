...
public class Mensagem {
    ...
    public static final String PRODUTO_NAO_SELECIONADO = "Nenhum Produto Selecionado!";

    public static final String ENTRADA_NAO_SELECIONADA = "Nenhuma Entrada Selecionado!";
